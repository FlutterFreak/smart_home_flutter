...
class AppColors {
  ...
  static Color primary = const Color(0xFF6806CF);
  static Color primary80 = const Color(0xFF6806CF).withOpacity(0.8);
  static Color primary60 = const Color(0xFF6806CF).withOpacity(0.6);
  static Color primary30 = const Color(0xFF6806CF).withOpacity(0.3);

  static Color secondary = const Color(0xFFb468f2);
  static Color secondary80 = const Color(0xFFb468f2).withOpacity(0.8);
  static Color secondary60 = const Color(0xFFb468f2).withOpacity(0.6);
  static Color secondary30 = const Color(0xFFb468f2).withOpacity(0.3);
  static Color secondary10 = const Color(0xFFb468f2).withOpacity(0.1);
