...
abstract class AppNavigator {
  ...
  static Future pushNamed(String route, {dynamic arguments}) {
    return key.currentState!.pushNamed(route, arguments: arguments);
  }

  static Future pushNamedReplacement(String route, {dynamic arguments}) {
    return key.currentState!.pushReplacementNamed(route, arguments: arguments);
  }

  static Future pushNamedAndClear(String route, {dynamic arguments}) {
  ...
  static Future<bool> maybePop([dynamic result]) {
